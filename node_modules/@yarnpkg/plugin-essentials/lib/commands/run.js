...
class RunCommand extends cli_1.BaseCommand {
    ...
    async execute() {
        ...
        if (binary) {
            ...
            return await core_2.scriptUtils.executePackageAccessibleBinary(effectiveLocator, this.scriptName, this.args, { cwd: this.context.cwd, project, stdin: this.context.stdin, stdout: this.context.stdout, stderr: this.context.stderr, nodeArgs });
        }
...
tslib_1.__decorate([
    clipanion_1.Command.String(`--inspect`, { tolerateBoolean: true, description: `Forwarded to the underlying Node process when executing a binary` })
], RunCommand.prototype, "inspect", void 0);
tslib_1.__decorate([
    clipanion_1.Command.String(`--inspect-brk`, { tolerateBoolean: true, description: `Forwarded to the underlying Node process when executing a binary` })
...
], RunCommand.prototype, "scriptName", void 0);
tslib_1.__decorate([
