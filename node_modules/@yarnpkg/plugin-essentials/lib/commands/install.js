...
class YarnCommand extends cli_1.BaseCommand {
    ...
    async execute() {
        ...
        const immutable = typeof this.immutable === `undefined` && typeof this.frozenLockfile === `undefined`
            ? (_a = configuration.get(`enableImmutableInstalls`)) !== null && _a !== void 0 ? _a : false : (_c = (_b = this.immutable) !== null && _b !== void 0 ? _b : this.frozenLockfile) !== null && _c !== void 0 ? _c : false;
...
tslib_1.__decorate([
    clipanion_1.Command.Boolean(`--immutable`, { description: `Abort with an error exit code if the lockfile was to be modified` })
], YarnCommand.prototype, "immutable", void 0);
tslib_1.__decorate([
    clipanion_1.Command.Boolean(`--immutable-cache`, { description: `Abort with an error exit code if the cache folder was to be modified` })
], YarnCommand.prototype, "immutableCache", void 0);
tslib_1.__decorate([
    clipanion_1.Command.Boolean(`--check-cache`, { description: `Always refetch the packages and ensure that their checksums are consistent` })
], YarnCommand.prototype, "checkCache", void 0);
tslib_1.__decorate([
    clipanion_1.Command.Boolean(`--production`, { hidden: true })
], YarnCommand.prototype, "production", void 0);
tslib_1.__decorate([
    clipanion_1.Command.Boolean(`--non-interactive`, { hidden: true })
], YarnCommand.prototype, "nonInteractive", void 0);
tslib_1.__decorate([
    clipanion_1.Command.Boolean(`--frozen-lockfile`, { hidden: true })
], YarnCommand.prototype, "frozenLockfile", void 0);
tslib_1.__decorate([
    clipanion_1.Command.Boolean(`--prefer-offline`, { hidden: true })
], YarnCommand.prototype, "preferOffline", void 0);
tslib_1.__decorate([
    clipanion_1.Command.Boolean(`--ignore-engines`, { hidden: true })
], YarnCommand.prototype, "ignoreEngines", void 0);
tslib_1.__decorate([
    clipanion_1.Command.String(`--registry`, { hidden: true })
], YarnCommand.prototype, "registry", void 0);
tslib_1.__decorate([
    clipanion_1.Command.Boolean(`--inline-builds`, { description: `Verbosely print the output of the build steps of dependencies` })
], YarnCommand.prototype, "inlineBuilds", void 0);
tslib_1.__decorate([
    clipanion_1.Command.Boolean(`--skip-builds`, { description: `Skip the build step altogether` })
], YarnCommand.prototype, "skipBuilds", void 0);
tslib_1.__decorate([
    clipanion_1.Command.String(`--cache-folder`, { hidden: true })
...
tslib_1.__decorate([
    ...
    clipanion_1.Command.Path(`install`)
], YarnCommand.prototype, "execute", null);
