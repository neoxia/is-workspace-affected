...
class DedupeCommand extends cli_1.BaseCommand {
    constructor() {
        super(...arguments);
        this.patterns = [];
        this.strategy = dedupeUtils.Strategy.HIGHEST;
        this.check = false;
        this.json = false;
    }
    async execute() {
...
], DedupeCommand.prototype, "patterns", void 0);
tslib_1.__decorate([
    clipanion_1.Command.String(`-s,--strategy`, { description: `The strategy to use when deduping dependencies` })
], DedupeCommand.prototype, "strategy", void 0);
tslib_1.__decorate([
    clipanion_1.Command.Boolean(`-c,--check`, { description: `Exit with exit code 1 when duplicates are found, without persisting the dependency tree` })
...
tslib_1.__decorate([
    clipanion_1.Command.Path(`dedupe`)
], DedupeCommand.prototype, "execute", null);
