...
exports.Driver = {
    ...
    async filterChanges(cwd, yarnRoots, yarnNames, opts) {
        ...
        const changePrefix = (opts === null || opts === void 0 ? void 0 : opts.staged) ? stagedPrefixes : unstagedPrefixes;
        const changes = [].concat(...lines.map((line) => {
            ...
            if (!(opts === null || opts === void 0 ? void 0 : opts.staged) && prefix === `?? ` && line.endsWith(`/`)) {
